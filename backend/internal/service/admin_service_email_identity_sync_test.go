...
func (s *emailSyncRepoStub) TransferBalance(context.Context, BalanceTransferInput) (*BalanceTransfer, error) {
	return nil, fmt.Errorf("unexpected TransferBalance call")
}
